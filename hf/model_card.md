...
Trained on [`DenSec02/glublm-60k-ted`](https://huggingface.co/datasets/DenSec02/glublm-60k-ted), a 60K-sample dataset of single-turn goldfish conversations generated by a team of four coordinated Claude agents (generator, critic, diversifier, persona-guardian). Topics span 85 categories across two groups: the goldfish's physical world and Ted Lasso wisdom filtered through goldfish naivete.
...
- **Batch size**: 64
- **Epochs**: 15
- **Final loss**: 1.64, test perplexity 12.14
